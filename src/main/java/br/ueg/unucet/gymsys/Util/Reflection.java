...
public class Reflection {
	...
	public static String getTableName(IModel<?> table){
		...
		try {
				...
				br.ueg.unucet.gymsys.Anotations.Table tableAnotation = cls.getAnnotation(br.ueg.unucet.gymsys.Anotations.Table.class);				
